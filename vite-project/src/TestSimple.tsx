    ...
    async function test() {
      try {
        ...
        if (error) {
          ...
          setDetails(`Error code: ${error.code}\nHint: Add http://localhost:5173 to Supabase Allowed Origins`)
        } else {
        ...
        setDetails('This is usually a CORS issue. Add http://localhost:5173 to Supabase Allowed Origins in Dashboard → Settings → API')
      }
    }
